...
@pytest.mark.parametrize("client_class,transport_name", [
    (DrydockServiceClient, "grpc"),
    (DrydockServiceAsyncClient, "grpc_asyncio"),
])
def test_drydock_service_client_from_service_account_info(client_class, transport_name):
...
def test_drydock_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
def test_transport_kind(transport_name):
    transport = DrydockServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_drydock_service_transport_auth_gdch_credentials(transport_class):
...
def test_drydock_service_host_no_port(transport_name):
    client = DrydockServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_drydock_service_host_with_port(transport_name):
    client = DrydockServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),

...
class tonnageCallTransformer(cst.CSTTransformer):
    ...
    'get_tonnage_fleet_development': ('range_', 'segment', 'sub_segment', 'group', 'metric', 'format_', 'excludeMpv', 'sort', ),
    ...
    'get_tonnage_fleet_status': ('range_', 'segment', 'sub_segment', 'group', 'metric', 'format_', 'excludeMpv', 'sort', ),

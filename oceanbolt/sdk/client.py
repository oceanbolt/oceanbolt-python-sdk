...
from oceanbolt.com import tonnage, portcalls, drydock, congestion, tradeflows, entities, polygonmanagement, \
    fleetmanagement, distancecalculator, custompolygon, vessels, vesselstates
...
class APIClient:
    ...
    def __init__(self, token=None):
        ...
        self.vesselStatesClient = vesselstates.VesselStateServiceClient(credentials=creds, client_info=OBClientInfo())

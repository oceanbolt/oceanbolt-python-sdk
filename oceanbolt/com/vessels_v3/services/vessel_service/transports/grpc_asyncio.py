...
from .base import VesselServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import VesselServiceGrpcTransport


class VesselServiceGrpcAsyncIOTransport(VesselServiceTransport):
    """gRPC AsyncIO backend transport for VesselService.
    ...
    def list_vessels(self) -> Callable[
            ...
            Awaitable[service.ListVesselsResponse]]:
    ...
    def list_stoppage_events(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListStoppageEventsRequest],
                    Awaitable[~.ListStoppageEventsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_dark_period_events(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListDarkPeriodEventsRequest],
                    Awaitable[~.ListDarkPeriodEventsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
...
__all__ = (
    'VesselServiceGrpcAsyncIOTransport',
)

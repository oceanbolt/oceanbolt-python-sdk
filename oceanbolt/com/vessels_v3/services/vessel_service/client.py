...
class VesselServiceClient(metaclass=VesselServiceClientMeta):
    ...
    def transport(self) -> VesselServiceTransport:
        ...
        Returns:
            VesselServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, VesselServiceTransport]] = None,
    ...
    def get_ais_summary(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a service.GetAisSummaryRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.GetAisSummaryRequest):
            request = service.GetAisSummaryRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_ais_summary]
    ...
    def __enter__(self) -> "VesselServiceClient":
        return self

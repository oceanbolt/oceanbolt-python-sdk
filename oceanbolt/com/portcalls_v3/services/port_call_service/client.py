...
from .transports.grpc import PortCallServiceGrpcTransport
from .transports.grpc_asyncio import PortCallServiceGrpcAsyncIOTransport


class PortCallServiceClientMeta(type):
    """Metaclass for the PortCallService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[PortCallServiceTransport]]
    _transport_registry["grpc"] = PortCallServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = PortCallServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[PortCallServiceTransport]:
...
class PortCallServiceClient(metaclass=PortCallServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            PortCallServiceClient: The constructed client.
        """
    ...
    def transport(self) -> PortCallServiceTransport:
        ...
        Returns:
            PortCallServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PortCallServiceTransport]] = None,
        ...
        if isinstance(transport, PortCallServiceTransport):
            # transport is a PortCallServiceTransport instance.
    ...
    def get_port_calls(self,
        ...
        # in a service.GetPortCallsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.GetPortCallsRequest):
            request = service.GetPortCallsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_port_calls]
    ...
    def get_port_call_timeseries(self,
            request: Optional[Union[service.GetPortCallsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_port_call_timeseries]
    ...
    def get_port_particulars(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a service.GetPortParticularsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.GetPortParticularsRequest):
            request = service.GetPortParticularsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_port_particulars]
    ...
    def __enter__(self) -> "PortCallServiceClient":
        return self

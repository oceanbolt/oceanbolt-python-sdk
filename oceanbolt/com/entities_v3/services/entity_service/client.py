...
class EntityServiceClient(metaclass=EntityServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, EntityServiceTransport]] = None,
    ...
    def list_segments(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_segments]
    ...
    def list_zones_with_polygons(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_zones_with_polygons]
    ...
    def list_commodities(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_commodities]
    ...
    def list_countries(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_countries]
    ...
    def list_regions_with_polygons(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_regions_with_polygons]
    ...
    def list_ports(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_ports]
    ...
    def search_polygons(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_polygons]
    ...
    def search_vessels(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_vessels]

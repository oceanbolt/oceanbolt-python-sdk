...
from .transports.grpc import CongestionServiceGrpcTransport
from .transports.grpc_asyncio import CongestionServiceGrpcAsyncIOTransport


class CongestionServiceClientMeta(type):
    """Metaclass for the CongestionService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[CongestionServiceTransport]]
    _transport_registry["grpc"] = CongestionServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = CongestionServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[CongestionServiceTransport]:
...
class CongestionServiceClient(metaclass=CongestionServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            CongestionServiceClient: The constructed client.
        """
    ...
    def transport(self) -> CongestionServiceTransport:
        ...
        Returns:
            CongestionServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, CongestionServiceTransport]] = None,
        ...
        if isinstance(transport, CongestionServiceTransport):
            # transport is a CongestionServiceTransport instance.
    ...
    def get_congestion_timeseries(self,
        ...
        # in a service.GetCongestionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.GetCongestionRequest):
            request = service.GetCongestionRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_congestion_timeseries]
    ...
    def get_congestion_web(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_congestion_web]
    ...
    def get_congestion_vessels(self,
            request: Optional[Union[service.GetCongestionRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_congestion_vessels]
    ...
    def __enter__(self) -> "CongestionServiceClient":
        return self

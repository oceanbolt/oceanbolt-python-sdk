...
class TradeFlowServiceTransport(abc.ABC):
    ...
    @property
    def get_trade_flows(self) -> typing.Callable[
    ...
    @property
    def get_trade_flow_aggregation(self) -> typing.Callable[
            [service.TradeFlowDataRequest],
            typing.Union[
                service.GetTradeFlowAggregationResponse,
                typing.Awaitable[service.GetTradeFlowAggregationResponse]
            ]]:
        raise NotImplementedError()
    ...
    @property
    def get_trade_flow_histogram(self) -> typing.Callable[
            [service.TradeFlowDataRequest],
            typing.Union[

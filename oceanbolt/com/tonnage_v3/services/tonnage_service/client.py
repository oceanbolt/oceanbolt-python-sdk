...
class TonnageServiceClientMeta(type):
    """Metaclass for the TonnageService client.
...
class TonnageServiceClient(metaclass=TonnageServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TonnageServiceClient: The constructed client.
        """
    ...
    def get_tonnage_zone_count(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_tonnage_zone_count]
    ...
    def get_tonnage_fleet_speed(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_tonnage_fleet_speed]
    ...
    def get_global_tonnage_status(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_global_tonnage_status]
    ...
    def get_tonnage_fleet_status(self,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.GetTonnageFleetRequest):
            request = service.GetTonnageFleetRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_tonnage_fleet_status]
    ...
    def get_tonnage_fleet_growth(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_tonnage_fleet_growth]
    ...
    def get_tonnage_chinese_waters(self,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.TonnageChineseWatersRequest):
            request = service.TonnageChineseWatersRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_tonnage_chinese_waters]
    ...
    def get_tonnage_zone_changes(self,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.GetTonnageZoneChangesRequest):
            request = service.GetTonnageZoneChangesRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_tonnage_zone_changes]
    ...
    def get_tonnage_basin_count(self,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.GetTonnageBasinRequest):
            request = service.GetTonnageBasinRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_tonnage_basin_count]

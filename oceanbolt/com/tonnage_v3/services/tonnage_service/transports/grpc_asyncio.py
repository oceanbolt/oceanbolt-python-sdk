...
from .grpc import TonnageServiceGrpcTransport
...
class TonnageServiceGrpcAsyncIOTransport(TonnageServiceTransport):
    ...
    def get_tonnage_zone_count(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetTonnageDataRequest],
                    Awaitable[~.GetTonnageZoneCountResponse]]:
    ...
    def get_tonnage_fleet_speed(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetTonnageDataRequest],
                    Awaitable[~.GetFleetSpeedResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_tonnage_fleet_status(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetTonnageFleetRequest],
                    Awaitable[~.GetTonnageFleetStatusResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_tonnage_chinese_waters(self) -> Callable[
        ...
        Returns:
            Callable[[~.TonnageChineseWatersRequest],
                    Awaitable[~.TonnageChineseWatersResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_tonnage_basin_count(self) -> Callable[
        ...
        Returns:
            Callable[[~.GetTonnageBasinRequest],
                    Awaitable[~.GetTonnageBasinResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
...
__all__ = (
    'TonnageServiceGrpcAsyncIOTransport',
)

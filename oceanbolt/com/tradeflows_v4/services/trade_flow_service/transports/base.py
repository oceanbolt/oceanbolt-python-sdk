...
class TradeFlowServiceTransport(abc.ABC):
    """Abstract transport class for TradeFlowService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_trade_flows: gapic_v1.method.wrap_method(
                self.get_trade_flows,
            ...
            self.get_trade_flow_timeseries: gapic_v1.method.wrap_method(
                self.get_trade_flow_timeseries,
                default_timeout=None,
                client_info=client_info,
            ),

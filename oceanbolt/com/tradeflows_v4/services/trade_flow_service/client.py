...
from oceanbolt.com.tradeflows_v4 import gapic_version as package_version
...
from .transports.grpc import TradeFlowServiceGrpcTransport
from .transports.grpc_asyncio import TradeFlowServiceGrpcAsyncIOTransport


class TradeFlowServiceClientMeta(type):
    """Metaclass for the TradeFlowService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[TradeFlowServiceTransport]]
    _transport_registry["grpc"] = TradeFlowServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = TradeFlowServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[TradeFlowServiceTransport]:
...
class TradeFlowServiceClient(metaclass=TradeFlowServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TradeFlowServiceClient: The constructed client.
        """
    ...
    def transport(self) -> TradeFlowServiceTransport:
        ...
        Returns:
            TradeFlowServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TradeFlowServiceTransport]] = None,
        ...
        if isinstance(transport, TradeFlowServiceTransport):
            # transport is a TradeFlowServiceTransport instance.
    ...
    def get_trade_flows(self,
        ...
        .. code-block:: python
            ...
            from oceanbolt.com import tradeflows_v4

            def sample_get_trade_flows():
                # Create a client
                client = tradeflows_v4.TradeFlowServiceClient()

                # Initialize request argument(s)
                request = tradeflows_v4.TradeFlowDataRequest(
                )
        ...
        Args:
            request (Union[oceanbolt.com.tradeflows_v4.types.TradeFlowDataRequest, dict]):
        ...
        Returns:
            oceanbolt.com.tradeflows_v4.types.GetTradeFlowsResponse:
        ...
        rpc = self._transport._wrapped_methods[self._transport.get_trade_flows]
    ...
    def get_trade_flow_aggregation(self,
        ...
        Returns:
            oceanbolt.com.tradeflows_v4.types.GetTradeFlowAggregationResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_trade_flow_aggregation]
    ...
    def get_trade_flow_timeseries(self,
            request: Optional[Union[service.TradeFlowDataRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Returns:
            oceanbolt.com.tradeflows_v4.types.GetTradeFlowTimeseriesResponse:
                Response object for trade flow
                timeseries queries
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_trade_flow_timeseries]
    ...
    def get_trade_flow_on_the_water(self,
            request: Optional[Union[service.TradeFlowDataRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_trade_flow_on_the_water]
    ...
    def get_trade_flow_histogram(self,
            request: Optional[Union[service.TradeFlowDataRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Returns:
            oceanbolt.com.tradeflows_v4.types.GetTradeFlowHistogramResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_trade_flow_histogram]
    ...
    def get_location_volume(self,
        ...
        Returns:
            oceanbolt.com.tradeflows_v4.types.GetLocationVolumeResponse:
    ...
    def get_trade_lane_metrics(self,
        ...
        Returns:
            oceanbolt.com.tradeflows_v4.types.GetTradeLaneMetricsResponse:
    ...
    def __enter__(self) -> "TradeFlowServiceClient":
        return self

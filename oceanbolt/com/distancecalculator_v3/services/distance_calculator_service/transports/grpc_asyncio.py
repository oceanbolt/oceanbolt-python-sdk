...
from .base import DistanceCalculatorServiceTransport, DEFAULT_CLIENT_INFO
from .grpc import DistanceCalculatorServiceGrpcTransport


class DistanceCalculatorServiceGrpcAsyncIOTransport(DistanceCalculatorServiceTransport):
    """gRPC AsyncIO backend transport for DistanceCalculatorService.
    ...
    @property
    def calculate_distance(self) -> Callable[
            [service.DistanceRequest],
            Awaitable[service.DistanceResponse]]:
        r"""Return a callable for the calculate distance method over gRPC.

        Calculates distances for the shortest route between a
        ...
        Returns:
            Callable[[~.DistanceRequest],
                    Awaitable[~.DistanceResponse]]:
        ...
        if 'calculate_distance' not in self._stubs:
            self._stubs['calculate_distance'] = self.grpc_channel.unary_unary(
                '/oceanbolt.com.distancecalculator.v3.DistanceCalculatorService/CalculateDistance',
                request_serializer=service.DistanceRequest.serialize,
                response_deserializer=service.DistanceResponse.deserialize,
            )
    ...
    def batch_calculate_distance(self) -> Callable[
        ...
        Returns:
            Callable[[~.BatchDistanceRequest],
                    Awaitable[~.BatchDistanceResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
...
__all__ = (
    'DistanceCalculatorServiceGrpcAsyncIOTransport',
)

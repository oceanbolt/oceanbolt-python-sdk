...
from .transports.grpc import DistanceCalculatorServiceGrpcTransport
from .transports.grpc_asyncio import DistanceCalculatorServiceGrpcAsyncIOTransport


class DistanceCalculatorServiceClientMeta(type):
    """Metaclass for the DistanceCalculatorService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[DistanceCalculatorServiceTransport]]
    _transport_registry["grpc"] = DistanceCalculatorServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = DistanceCalculatorServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[DistanceCalculatorServiceTransport]:
...
class DistanceCalculatorServiceClient(metaclass=DistanceCalculatorServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DistanceCalculatorServiceClient: The constructed client.
        """
    ...
    def transport(self) -> DistanceCalculatorServiceTransport:
        ...
        Returns:
            DistanceCalculatorServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DistanceCalculatorServiceTransport]] = None,
        ...
        if isinstance(transport, DistanceCalculatorServiceTransport):
            # transport is a DistanceCalculatorServiceTransport instance.
    ...
    def calculate_distance(self,
        ...
        # in a service.DistanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.DistanceRequest):
            request = service.DistanceRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.calculate_distance]
    ...
    def batch_calculate_distance(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a service.BatchDistanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.BatchDistanceRequest):
            request = service.BatchDistanceRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_calculate_distance]
    ...
    def __enter__(self) -> "DistanceCalculatorServiceClient":
        return self

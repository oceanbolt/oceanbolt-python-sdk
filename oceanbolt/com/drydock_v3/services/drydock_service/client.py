...
from .transports.grpc import DrydockServiceGrpcTransport
from .transports.grpc_asyncio import DrydockServiceGrpcAsyncIOTransport


class DrydockServiceClientMeta(type):
    """Metaclass for the DrydockService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[DrydockServiceTransport]]
    _transport_registry["grpc"] = DrydockServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = DrydockServiceGrpcAsyncIOTransport

    def get_transport_class(cls,
            label: Optional[str] = None,
        ) -> Type[DrydockServiceTransport]:
...
class DrydockServiceClient(metaclass=DrydockServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DrydockServiceClient: The constructed client.
        """
    ...
    def transport(self) -> DrydockServiceTransport:
        ...
        Returns:
            DrydockServiceTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DrydockServiceTransport]] = None,
        ...
        if isinstance(transport, DrydockServiceTransport):
            # transport is a DrydockServiceTransport instance.
    ...
    def get_dry_dock_stays(self,
        ...
        # in a service.GetDryDockStaysRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, service.GetDryDockStaysRequest):
    ...
    def __enter__(self) -> "DrydockServiceClient":
        return self
